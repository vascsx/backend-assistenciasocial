...
// Configurações do Swaggerapp.register(fastifySwagger, {  openapi: usersSwagger.openapi,});app.register(fastifySwaggerUI, {  routePrefix: '/docs',  uiConfig: {    docExpansion: 'list',    deepLinking: true,  },  staticCSP: true,  transformStaticCSP: (header: string): string => header,});
